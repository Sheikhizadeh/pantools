...
public class genome_bank {
    ...
    public genome_bank(String path) //throws IOException
    {
        int g,s,k;
        BufferedReader in;
        try{
            ...
            in.close();
            genomes_file=new RandomAccessFile(path+"/genomes.db","r");
    ...
    //,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,
    public genome_bank(String path, String file, boolean adding) throws IOException
    {
        int g,s,i;
        previous_num_genomes=0;
        if(adding)  
    ...
    */      
    public void load_genomes(String path)  throws IOException
    {
        String line;
        char carry;
        boolean havecarry;
    ...
    */
    public boolean compare(genome_bank second, int[] a1, int[] a2, int len, boolean forward)
    {
        int i;
        boolean equal=true;
        if(forward)
